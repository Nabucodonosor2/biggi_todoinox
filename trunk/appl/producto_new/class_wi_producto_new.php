...
class wi_producto_base extends w_input{
    ...
    function wi_producto_base($cod_item_menu){
        /////////////////////////////////////////////TAB_1/////////////////////////////////////////////
        parent::w_input('producto_new', $cod_item_menu);
...
$file_name = dirname(__FILE__)."/".K_CLIENTE."/class_wi_producto_new.php";
if (file_exists($file_name))
    require_once($file_name);
    else {
        class wi_producto_new extends wi_producto_base {
            function __construct($cod_item_menu) {
                parent::__construct($cod_item_menu);
            }
        }
