...
class wo_producto_new extends wo_producto_base{
    ...
    function __construct(){
        ...
        parent::w_output_biggi('producto_new', $sql, $_REQUEST['cod_item_menu']);
        ...
        $this->add_header(new header_num('PRECIO_VENTA_PUBLICO', 'PRECIO_VENTA_PUBLICO', 'Precio Publico'));
