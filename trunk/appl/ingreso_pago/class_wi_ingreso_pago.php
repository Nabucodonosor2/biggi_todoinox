...
class wi_ingreso_pago_base extends w_input {
	...
	function navegacion(&$temp){
		...
		if($cod_estado_ingreso_pago == 2 && 
				($this->cod_usuario == 35 
				or $this->cod_usuario == 1 
				or $this->cod_usuario == 7 
				or $this->cod_usuario == 20 
				or $this->cod_usuario == 4
				or $this->cod_usuario == 31  
				or $this->cod_usuario == 22)){
	...
	function envio_mail(){
		...
		$lista_mail_to		= "'mscianca@todoinox.cl'";
		$lista_mail_to_name	= "'Margaria Scianca'";

		$lista_mail_cc		= "'ascianca@biggi.cl;lsun@todoinox.cl;lwu@todoinox.cl;jcatalan@biggi.cl;sergio.pechoante@biggi.cl;'";
		$lista_mail_cc_name	= "'Angel Scianca;Lifen Sun;Loreto Wu;Jose Catalan;Sergio Pechoante'";
