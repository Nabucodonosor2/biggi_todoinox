...
class wi_ingreso_pago_base extends w_input {
	...
	function envio_mail(){
		...
		$lista_mail_cc		= "'ascianca@biggi.cl;sergio.pechoante@biggi.cl;lsun@todoinox.cl;lwu@todoinox.cl;rescudero@biggi.cl;jcatalan@biggi.cl'";
		$lista_mail_cc_name	= "'Angel Scianca;Sergio Pechoante;Lifen Sun;Loreto Wu;Rafael Escudero;José Catalan'";
