...
require_once("class_print_reporte.php");
...
$rpt = new print_reporte($sql, K_ROOT_DIR.'appl/orden_compra/orden_compra.xml', $labels, "Orden de Compra ".$cod_orden_compra, 1, true);
