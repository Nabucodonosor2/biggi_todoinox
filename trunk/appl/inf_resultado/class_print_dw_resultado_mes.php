...
class print_dw_resultado_mes extends reporte {
	function print_dw_resultado_mes($sql, $xml, $labels=array(), $titulo, $con_logo, $vuelve_a_presentacion=false) {
	...
	function modifica_pdf(&$pdf) {
		...
		$pdf->SetXY(30,15);
		$pdf->Cell(555, 15, 'HEHJEHEHEJEHDJDH', '', '','L');*/
	}
}
?>