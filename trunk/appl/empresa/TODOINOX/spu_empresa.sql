...
alter PROCEDURE [dbo].[spu_empresa](@ve_operacion varchar(30)
							...
							,@ve_dscto_permitido T_PORCENTAJE = null
	...
	if (@ve_operacion='INSERT') 
		...
		begin
			...
			set rut = @ve_rut, 
				...
				dscto_permitido = @ve_dscto_permitido,
