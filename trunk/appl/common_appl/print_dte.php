...
switch ($DTE_ORIGEN) {
	...
	if($ES_CEDIBLE == 'N'){
		...
		$pdf->Image($imagen,6,7,36,34);
		$pdf->SetDrawColor(255,0,0);	
		$pdf->SetLineWidth(1);
		$pdf->Rect(136, 10, 69, 30);
		$pdf->SetTextColor(255,0,0);
		$pdf->SetFont('helvetica','B',12.25);	
		$pdf->Text(149, 15,'R.U.T.: 89.257.000-0');
		$pdf->Text(144, 22,'FACTURA ELECTRONICA');
		$pdf->Text(159, 28,utf8_encode('N°: ').$folio);
		$pdf->SetFont('helvetica','B',8.75);
		$pdf->Text(149, 42,'S.I.I - SANTIAGO CENTRO');
		$pdf->SetTextColor(0,0,0);
		$pdf->Text(40, 15,'COMERCIALTODOINOX LIMITADA');
		...
		$pdf->Text(40, 30,utf8_encode('PORTUGAL N° 1726 - SANTIAGO - CHILE'));
		$pdf->Text(40, 35,'FONOS: (56-2)2412-6200 - 25552849 - FAX(56-2)24126201 - 25512750');
	...
	$pdf->SetTextColor(255,0,0);
	$pdf->SetFont('helvetica','B',12.25);	
	$pdf->Text(149, 13,'R.U.T.: 89.257.000-0');
	$pdf->Text(148, 20,'GUIA DE DESPACHO');
	$pdf->Text(154, 27,'ELECTRONICA');
	$pdf->Text(159, 33,utf8_encode('N°: ').$folio);
	$pdf->SetFont('helvetica','B',8.75);
	$pdf->Text(149, 42,'S.I.I - SANTIAGO CENTRO');
	...
	$pdf->SetFont('helvetica','B',12.25);	
	$pdf->Text(149, 13,'R.U.T.: 89.257.000-0');
	$pdf->Text(148, 20,'NOTA DE CREDITO');
	$pdf->Text(154, 27,'ELECTRONICA');
	$pdf->Text(159, 33,utf8_encode('N°: ').$folio);
	$pdf->SetFont('helvetica','B',8.75);
	$pdf->Text(149, 42,'S.I.I - SANTIAGO CENTRO');
