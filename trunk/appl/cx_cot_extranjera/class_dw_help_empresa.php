...
class dw_help_empresa extends datawindow {
	...
	function add_controls_empresa_help($tipo_empresa = 'C') {
		...
		*/
		...
		$this->add_control($control = new edit_text_upper('COD_PROVEEDOR_EXT', 10, 10));
		...
		$this->add_control(new static_text('NOM_PAIS'));
		...
		$this->add_control(new static_text('POST_OFFICE_BOX'));
		
		$this->set_mandatory('COD_PROVEEDOR_EXT', 'Code Provider');
	}
}
?>