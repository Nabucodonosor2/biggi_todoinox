...
class dw_item_nota_credito_read_only extends datawindow {
    ...
    function dw_item_nota_credito_read_only() {
        ...
        //$this->add_controls_producto_help();		// Debe ir despues de los computed donde esta involucrado precio, porque add_controls_producto_help() afecta el campos PRECIO
        $this->add_control(new edit_text_hidden('COD_PRODUCTO_INC','hidden'));
        /*
...
class wi_inf_ventas_por_equipo extends w_input {
    ...
    function load_record() {
        ...
        if ($this->tipo_doc == 'FA') {
            ...
            $this->dws['dw_nota_credito']->set_item(0, 'TAB_153505', 'none');
            $this->dws['dw_nota_credito']->set_item(0, 'TAB_153510', 'none');
            $this->dws['dw_nota_credito']->set_item(0, 'TAB_153515', 'none');
            $this->dws['dw_nota_credito']->set_item(0, 'TAB_153520', 'none');
            $this->dws['dw_nota_credito']->set_item(0, 'TAB_153525', '');
            $this->dws['dw_nota_credito']->set_item(0, 'TAB_153530', '');
