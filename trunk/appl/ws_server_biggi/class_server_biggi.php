...
class server_biggi{
	...
	function svr_orden_despacho_to_nv($cod_orden_compra){
		...
		$result = array();
		$result['ORDEN_DESPACHO'] = $result_ws;
	...
	// LA FUNCIONA "svr_consulta_stock" NO EXISTIA.
	// FUE AGREGADA POR MH EL 11102020, AL PARECER LA BORRARO POR ERROR, LA FUNCION FUE RESCATADA DEL ARCHIVO "class_server_biggi_07102019.php"
