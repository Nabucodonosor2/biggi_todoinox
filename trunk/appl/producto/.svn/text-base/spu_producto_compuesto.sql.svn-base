CREATE PROCEDURE [dbo].[spu_producto_compuesto]( @ve_operacion varchar(20)
...
BEGIN
	if (@ve_operacion='INSERT') begin
		insert into producto_compuesto (cod_producto,cod_producto_hijo,orden,cantidad, genera_compra)
		values (@ve_cod_producto,@ve_cod_producto_hijo,@ve_orden,@ve_cantidad, @ve_genera_compra)
	end 
