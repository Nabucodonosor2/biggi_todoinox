...
class wi_inf_bodega_tarjeta_existencia extends w_param_informe_biggi {	
	function wi_inf_bodega_tarjeta_existencia($cod_item_menu) {
		...
		parent::w_param_informe_biggi('inf_bodega_tarjeta_existencia', $cod_item_menu, 'Tarjeta', $xml, '', 'spi_bodega_tarjeta_existencia');
